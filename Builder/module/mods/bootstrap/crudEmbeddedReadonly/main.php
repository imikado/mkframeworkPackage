<?php
class module_mods_bootstrap_crudEmbeddedReadonly extends abstract_moduleBuilder{

	protected $sModule='mods_bootstrap_crudEmbeddedReadonly';
	protected $sModuleView='mods/bootstrap/crudEmbeddedReadonly';
