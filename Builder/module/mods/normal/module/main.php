<?php
class module_mods_normal_module extends abstract_moduleBuilder{

	protected $sModule='mods_normal_module';
	protected $sModuleView='mods/normal/module';
	...
	public function _index(){
		...
		if($this->isPost()){
			...
			foreach($tAction as $sAction){
				$detail.='<br />- <a href="'._root::getConfigVar('path.generation')._root::getParam('id').'/public/index.php?:nav='.$sModule.'::'.$sAction.'">index.php?:nav='.$sModule.'::'.$sAction.'</a>';
			}
		}
