<?php
class module_mods_all_sgbdJsonIndex extends abstract_moduleBuilder{

	protected $sModule='mods_all_sgbdJsonIndex';
	protected $sModuleView='mods/all/sgbdJsonIndex';
