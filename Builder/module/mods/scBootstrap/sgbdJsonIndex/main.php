...
class module_mods_scBootstrap_sgbdJsonIndex extends abstract_moduleBuilder {

	protected $sModule = 'mods_scBootstrap_sgbdJsonIndex';
	protected $sModuleView = 'mods/scBootstrap/sgbdJsonIndex';
