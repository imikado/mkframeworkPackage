...
class module_mods_scBootstrap_menu extends abstract_moduleBuilder {

	protected $sModule = 'mods_scBootstrap_menu';
	protected $sModuleView = 'mods/scBootstrap/menu';
	private $msg = null;
	private $detail = null;
	private $tError = null;
	private $sError=null;
	...
	public function _index() {
		...
		$tModule = module_builder::getTools()->getListModuleAndSousModule();
		$tModuleAndMethod = array();
		foreach ($tModule as $sModuleName) {

			$sClassName = str_replace('/', '_', $sModuleName);
			...
			$tMethods = get_class_methods('module_' . $sClassName);
			...
			$tModuleAndMethod[$sClassName] = $tMethods;
		}
