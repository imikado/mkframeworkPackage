...
{
    protected $_sModulePath = 'VARmoduleParentENDVAR/VARmoduleRightsManagerENDVAR';
    protected $_sModuleName = 'VARmoduleParentENDVAR_VARmoduleRightsManagerENDVAR';
    ...
    {
        _root::redirect($this->_sModuleName .'::'.$sAction_);
    }
    ...
    public function _delete()
    {
        ...
        $oPermission=VARmodel_rightManagerENDVAR::getInstance()->findById(_root::getParam('id'));
        $oView=$oView=$this->getView('delete');
        $oView->oPermission=$oPermission;
