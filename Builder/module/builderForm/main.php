...
class module_builderForm {
	...
	private function algo_concatParam($oSourceMain_,$oObject_,$tParam_,$tVar_,$tConcatVar_){
		...
		$sSep=null;
		if( isset($oObject_['concatSep']) and $tVar_[(string) $oObject_['name']] != null ){
			$sSep=(string)$oObject_['concatSep'];
		}

		$tParam_[(string) $oObject_['name']] .= $sSep . $this->getVarInTab($tVar_, (string) $oObject_['value']);
	...
	private function algo_concatVar($oSourceMain_,$oObject_,$tParam_,$tVar_,$tConcatVar_){
		...
		$tVar_[(string) $oObject_['name']] .= $sSep . $this->getVarInTab($tVar_, (string) $oObject_['value']);
