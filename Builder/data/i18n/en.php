...
_root::setConfigVar('tLangue', array(
    'Liste_des_projets' => 'Projects list',
    'menuApplication' => 'Application menu',
//menu top
...
during the generation a new specific layout for bootstrap will be created, and the builder will generate CRUD and module bootstrap compatible.',
    ...
    'builder::langVousPouvezEcrire' => '<p>You should write </p><pre>%s</pre><p> in your file %s</p>',
    'builder::langVotreLangueEstDeja' => '<p>You language is still "%s" </p>',
//simple table
