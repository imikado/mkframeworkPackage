...
<head>
<title>Builder</title>
<link rel="stylesheet" type="text/css" href="css/mainCodeFrame.css" media="screen" />
...
function gotofile(sFile){
	document.location.href='<?php echo _root::getLink('code::editcode',array('project'=>_root::getParam('project'),'file'=>_root::getConfigVar('path.generation')._root::getParam('project').'/'),false)?>'+sFile;
	window.parent.selectFile('<?php echo _root::getConfigVar('path.generation')._root::getParam('project')?>/'+sFile);
}
function gotofileandmethod(sFile,sType,sMethod){
	document.location.href='<?php echo _root::getLink('code::editcode',array('project'=>_root::getParam('project'),'file'=>_root::getConfigVar('path.generation')._root::getParam('project').'/'),false)?>'+sFile+'&type='+sType+'&method='+sMethod;
	window.parent.selectFile('<?php echo _root::getConfigVar('path.generation')._root::getParam('project')?>/'+sFile);
}
function gotofileandtype(sFile,sType){
	document.location.href='<?php echo _root::getLink('code::editcode',array('project'=>_root::getParam('project'),'file'=>_root::getConfigVar('path.generation')._root::getParam('project').'/'),false)?>'+sFile+'&type='+sType;
	window.parent.selectFile('<?php echo _root::getConfigVar('path.generation')._root::getParam('project')?>/'+sFile);
}
var tmpLine='';
